...
namespace Monitor
{
        public abstract class Device:INotifyPropertyChanged
        {
                ...
                public Device(byte addr,DeviceType type,string name)
                {
                        Address = addr;
                        DvType = type;
                        Name = name;
                ...
                {
                        string path = string.Format("Devices\\{0}.xml", DvType);
